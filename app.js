...
var App = function () {
  function App() {
    ...
    this.openDetailsPopup = function (detailsId) {
      _this.popup.open(detailsId);
    };

    this.setLanguage = function (lang) {
      var languageToSet = lang;

      if (!languageToSet) {
        var persistedLanguage = localStorage && localStorage.getItem(UI_LANG_KEY);
        var browserLanguage = (navigator.language || 'en-US').split('-')[0];
        languageToSet = persistedLanguage || browserLanguage || 'en';
      }

      _this.language = languageToSet;

      localStorage && localStorage.setItem(UI_LANG_KEY, _this.language);

      document.body.querySelectorAll('[class*=\'i18n-\']').forEach(function (langElem) {
        if (langElem.classList.contains('i18n-' + _this.language)) {
      ...
      _this.calendar && _this.calendar.setLanguage(_this.language);
    };
  }
  ...
  App.prototype.init = function init() {
    ...
    this.header = new _header2.default({
      el: this.dom.header,
      onDetailsClick: this.openDetailsPopup,
      onLanguageChange: function onLanguageChange(languageId) {
        _this2.setLanguage(languageId);
      }
    });
    ...
    this.calendar = new _calendar2.default({
      ...
      onLoadingState: function onLoadingState(loadingState) {
        var classList = _this2.dom.spinner.classList;
        if (loadingState) {
...
// module
exports.push([module.i, "#spinner-wrapper {\n  height: calc(100vh - 48px);\n  display: flex;\n  justify-content: center;\n  align-items: center; }\n  #spinner-wrapper.hidden {\n    display: none; }\n\nbody {\n  margin: 0;\n  font-family: Verdana, Geneva, sans-serif;\n  color: #3498db; }\n  body.noscroll {\n    overflow: hidden; }\n  body a, body .clickable, body [data-detail], body [data-language] {\n    cursor: pointer; }\n    body a:hover, body .clickable:hover, body [data-detail]:hover, body [data-language]:hover {\n      opacity: .8;\n      text-decoration: underline; }\n  body a {\n    text-decoration: none; }\n    body a:visited {\n      color: inherit; }\n  body p {\n    font-size: 16px; }\n\n.app-wrapper {\n  background: white;\n  box-sizing: border-box; }\n\n#calendar-iframe {\n  border: none; }\n\n#calendar-wrapper {\n  display: none;\n  min-height: 800px;\n  height: calc(90% - 48px);\n  margin-bottom: 8px; }\n\n#calendar-wrapper.loaded {\n  display: flex;\n  justify-content: center;\n  flex: 1;\n  width: 100%;\n  padding: 0 5px;\n  align-self: baseline; }\n\n.i18n-en:not(.active), .i18n-es:not(.active) {\n  display: none; }\n", ""]);
...
var Popup = function () {
  function Popup(_ref) {
    ...
    var clickClosingElements = [this.dom.wrapper, this.dom.close];
    clickClosingElements.forEach(function (i) {
  ...
  Popup.prototype.open = function open(contentId) {
    ...
    this.dom.content.querySelectorAll('.popup-section').forEach(function (section) {
...
var Header = function Header(_ref) {
  ...
  this.props = { onDetailsClick: onDetailsClick, onLanguageChange: onLanguageChange };
  this.dom = {
    header: el,
    languageSelector: el.getElementsByClassName('lauguage-selector')[0]
  };

  this.dom.header.querySelectorAll('[data-detail]').forEach(function (detailsElement) {
    detailsElement.addEventListener('click', function () {
      _this.props.onDetailsClick(detailsElement.getAttribute('data-detail'));
    });
  });

  this.dom.languageSelector.querySelectorAll('[data-language]').forEach(function (languageElement) {
    languageElement.addEventListener('click', function () {
      _this.props.onLanguageChange(languageElement.getAttribute('data-language'));
    });
  });
};
...
// module
exports.push([module.i, "#header {\n  display: flex;\n  flex-direction: row;\n  align-items: baseline;\n  min-height: 48px;\n  margin-bottom: 12px;\n  width: 100%;\n  background-color: #e3e9ff;\n  padding: 0 14px 0 21px;\n  box-sizing: border-box; }\n  #header > div:not(:first-child) {\n    padding-left: 12px; }\n  #header .lauguage-selector {\n    display: flex;\n    flex-direction: row; }\n  #header [data-language] {\n    cursor: pointer; }\n    #header [data-language]:not(:last-child) {\n      margin-right: 4px; }\n  #header #more-details {\n    flex: 2;\n    display: flex;\n    flex-direction: row;\n    justify-content: center;\n    font-size: 0.9em;\n    align-self: center; }\n    #header #more-details [data-detail]:not(:last-child) {\n      margin-right: 16px; }\n\n.title {\n  align-self: center;\n  font-weight: 700;\n  font-size: 1.4em;\n  font-family: Georgia, serif; }\n  .title a:link {\n    text-decoration: none; }\n\n.sub-title {\n  text-align: left;\n  flex: 1; }\n", ""]);
...
module.exports = "<svg viewBox=\"0 0 38 38\" xmlns=\"http://www.w3.org/2000/svg\" stroke=\"#fff\"><g fill=\"none\" fill-rule=\"evenodd\"><g transform=\"translate(1 1)\" stroke-width=\"2\"><circle stroke-opacity=\".5\" cx=\"18\" cy=\"18\" r=\"18\"></circle><path d=\"M36 18c0-9.94-8.06-18-18-18\"><animateTransform attributeName=\"transform\" type=\"rotate\" from=\"0 18 18\" to=\"360 18 18\" dur=\"1s\" repeatCount=\"indefinite\"></animateTransform></path></g></g></svg>"
...
var Footer = function Footer(_ref) {
  ...
  this.dom.footer.querySelectorAll('[data-detail]').forEach(function (detailsElement) {
    detailsElement.addEventListener('click', function () {
      _this.props.onDetailsClick(detailsElement.getAttribute('data-detail'));
    });
  });
...
var calLinks = ['eventos%40quepasaalpujarra.com', 'quepasaalpujarra%40gmail.com', 'en.spain%23holiday%40group.v.calendar.google.com'];
...
var Calendar = function () {
  function Calendar(_ref) {
    ...
    var el = _ref.el,
        ...
        onLoadingState = _ref.onLoadingState;

    _classCallCheck(this, Calendar);

    this.render = function () {
      var srcPart = calLinks.map(function (calUrl) {
        return 'src=' + calUrl;
      }).join('&');
      var calIframe = document.createElement('iframe');
      calIframe.src = 'https://calendar.google.com/calendar/embed?&ctz=Europe/Madrid&hl=' + _this.language + '&' + srcPart;
      ...
      _this.onLoadingState(true);
      _this.dom.calendar.innerHTML = '';
      _this.dom.calendar.appendChild(calIframe);
  ...
  Calendar.prototype.setLanguage = function setLanguage(language) {
